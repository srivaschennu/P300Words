...
EEG.chanlocs = pop_readlocs([chanlocpath chanlocfile]);
%create an empty Cz reference channel for now
EEG.nbchan = length(EEG.chanlocs);
EEG.data(EEG.nbchan,:) = 0;
EEG.chaninfo.nodatchans(strcmp('Cz',{EEG.chaninfo.nodatchans.labels})).labels = 'REF';
